...
module.exports.setupDevServer = ({ server, templatePath, onUpdate }) => new Promise((resolve, reject) => {
  ...
  const devMiddleware = require('../middleWares/webpack-dev-server-koa')(clientCompiler, {
  ...
  server.use(require('../middleWares/webpack-hot-middleware-koa')(clientCompiler, { heartbeat: 5000 }))
